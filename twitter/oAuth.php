...
class OAuth_Twitter {
	...
	public $http_info;
	/* Set the useragnet. */
	public $useragent = 'OAuth_Twitter v0.2.1 (api/1.1)';
	/* Set the URL's */
	...
	/**
	 * construct OAuth_Twitter object
	 * @param $consumer_key
	...
	/**
	 * Setup a new OAuthConsumer object using the given token/secret
	 *
	 * @param string $oauth_token
	 * @param string $oauth_token_secret
	 */
	public function updateAccessToken($oauth_token ='', $oauth_token_secret = '') {
		if (!empty($oauth_token) && !empty($oauth_token_secret)) {
			$this->token = new OAuthConsumer($oauth_token, $oauth_token_secret);
		} else {
	...
	/**
	 * Clears the token attribute (by setting it to null)
	 */
